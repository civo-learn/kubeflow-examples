...
parser.add_argument('--prompt', type=str, required=True, help='Prompt for the model', default="What is Civo Cloud and what do they do?")
...
response = requests.post(
    f"http://localhost:8080/v1/models/serving:predict",
